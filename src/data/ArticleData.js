const ArticleData = [
  {
    ...
    img3: '',
    img1caption: 'Så er der gang i bageriet.',
    img2caption: 'Uden stenoven og krikke - duer hesten ikke',
    img3caption: '',
    title: 'Det blev varmt i bageriet',
    text1:
      "Det er tirsdag morgen. Jeg er stået op før solen og er på vej ned til bageriet på nordre stationsvej. Jeg skal til at åbne min bageridør, da min e-boks app på min nyindkøbte iPhone pludselig siger: 'Ny besked fra erhvervs- og selskabsstyrelsen'...",
    text2:
  ...
  },
  {
    ...
    img3: '',
    img1caption: 'Det må man kalde en ordenlig bøf :)',
    img2caption: 'Endeligt har jeg råd til at købe en slibesten.',
    img3caption: '',
    title: 'Jeg kan fortsætte som slagter',
    text1:
      'Jeg var slagter med en slagtersvend, et sundt regnskab og en bugnende rif-raf pengepung fra Berlin. Så kom Covid-19 og min hang for at gamble kom igen. Jeg stod nu uden slagtersvend og med et regnskab der var løbet løbsk. Jeg har nu endeligt fået løst mit problem...',
    text2:
  ...
  },
  {
    ...
    img1caption: 'Mig der laver regnskab.',
    img2caption: 'Rikke og Jens. Jens var irriterende og kom for tidligt.',
    img3caption: "Det ik' så ringe endda.",
    title: 'Ingen tid til latté art',
    text1:
